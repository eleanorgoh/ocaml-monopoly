...
let state_1 = init_state board players_1
let state_2 = init_state board players_2
let state_3 = init_state board players_3
...
let init_state_board_tests = [
  init_state_board_test "State: 1, Board: Board.json" state_1 board;
  init_state_board_test "State: 2, Board: Board.json" state_2 board;
  init_state_board_test "State: 3, Board: Board.json" state_3 board
]
